...
export declare const enum GitConfigLocation {
    Local = "local",
    Global = "global",
    System = "system"
}
...
export declare const enum GitPushBranchMode {
    Normal = "",
    Force = "force",
...
export declare type GitRepoConfigBranches = {
    [branchName: string]: GitRepoConfigBranch;
};
...
export declare const enum PullRequestProvider {
    Bitbucket = 0,
    Custom = 1,
    GitHub = 2,
    GitLab = 3
...
export declare type PullRequestConfig = PullRequestConfigBuiltIn | PullRequestConfigCustom;
...
export declare type LoadGitGraphViewTo = {
...
export declare const enum BooleanOverride {
    Default = 0,
    Enabled = 1,
    Disabled = 2
}
export declare const enum CommitDetailsViewLocation {
    Inline = 0,
    DockedToBottom = 1
}
export declare const enum CommitOrdering {
    Date = "date",
...
export declare const enum DateFormatType {
    DateAndTime = 0,
    DateOnly = 1,
    Relative = 2
}
export declare const enum DateType {
    Author = 0,
    Commit = 1
}
...
export declare const enum FileViewType {
    Default = 0,
    Tree = 1,
    List = 2
}
export declare const enum GraphStyle {
    Rounded = 0,
    Angular = 1
}
export declare const enum GraphUncommittedChangesStyle {
    OpenCircleAtTheUncommittedChanges = 0,
    OpenCircleAtTheCheckedOutCommit = 1
}
export declare const enum RefLabelAlignment {
    Normal = 0,
    BranchesOnLeftAndTagsOnRight = 1,
    BranchesAlignedToGraphAndTagsOnRight = 2
}
export declare const enum RepoCommitOrdering {
    Default = "default",
    Date = "date",
    AuthorDate = "author-date",
    Topological = "topo"
}
export declare const enum RepoDropdownOrder {
    FullPath = 0,
    Name = 1,
    WorkspaceFullPath = 2
}
export declare const enum SquashMessageFormat {
    Default = 0,
    GitSquashMsg = 1
}
export declare const enum TabIconColourTheme {
    Colour = 0,
    Grey = 1
}
...
export declare type ErrorInfo = string | null;
export declare const enum ErrorInfoExtensionPrefix {
...
export declare const enum MergeActionOn {
    Branch = "Branch",
...
export declare const enum RebaseActionOn {
    Branch = "Branch",
    Commit = "Commit"
}
...
export declare type RequestMessage = RequestAddRemote | RequestAddTag | RequestApplyStash | RequestBranchFromStash | RequestCheckoutBranch | RequestCheckoutCommit | RequestCherrypickCommit | RequestCleanUntrackedFiles | RequestCommitDetails | RequestCompareCommits | RequestCopyFilePath | RequestCopyToClipboard | RequestCreateArchive | RequestCreateBranch | RequestCreatePullRequest | RequestDeleteBranch | RequestDeleteRemote | RequestDeleteRemoteBranch | RequestDeleteTag | RequestDeleteUserDetails | RequestDropCommit | RequestDropStash | RequestEditRemote | RequestEditUserDetails | RequestEndCodeReview | RequestExportRepoConfig | RequestFetch | RequestFetchAvatar | RequestFetchIntoLocalBranch | RequestLoadCommits | RequestLoadConfig | RequestLoadRepoInfo | RequestLoadRepos | RequestMerge | RequestOpenExtensionSettings | RequestOpenExternalDirDiff | RequestOpenExternalUrl | RequestOpenFile | RequestOpenTerminal | RequestPopStash | RequestPruneRemote | RequestPullBranch | RequestPushBranch | RequestPushStash | RequestPushTag | RequestRebase | RequestRenameBranch | RequestRescanForRepos | RequestResetFileToRevision | RequestResetToCommit | RequestRevertCommit | RequestSetGlobalViewState | RequestSetRepoState | RequestSetWorkspaceViewState | RequestShowErrorDialog | RequestStartCodeReview | RequestTagDetails | RequestUpdateCodeReview | RequestViewDiff | RequestViewDiffWithWorkingFile | RequestViewFileAtRevision | RequestViewScm;
export declare type ResponseMessage = ResponseAddRemote | ResponseAddTag | ResponseApplyStash | ResponseBranchFromStash | ResponseCheckoutBranch | ResponseCheckoutCommit | ResponseCherrypickCommit | ResponseCleanUntrackedFiles | ResponseCompareCommits | ResponseCommitDetails | ResponseCopyFilePath | ResponseCopyToClipboard | ResponseCreateArchive | ResponseCreateBranch | ResponseCreatePullRequest | ResponseDeleteBranch | ResponseDeleteRemote | ResponseDeleteRemoteBranch | ResponseDeleteTag | ResponseDeleteUserDetails | ResponseDropCommit | ResponseDropStash | ResponseEditRemote | ResponseEditUserDetails | ResponseExportRepoConfig | ResponseFetch | ResponseFetchAvatar | ResponseFetchIntoLocalBranch | ResponseLoadCommits | ResponseLoadConfig | ResponseLoadRepoInfo | ResponseLoadRepos | ResponseMerge | ResponseOpenExtensionSettings | ResponseOpenExternalDirDiff | ResponseOpenExternalUrl | ResponseOpenFile | ResponseOpenTerminal | ResponsePopStash | ResponsePruneRemote | ResponsePullBranch | ResponsePushBranch | ResponsePushStash | ResponsePushTag | ResponseRebase | ResponseRefresh | ResponseRenameBranch | ResponseResetFileToRevision | ResponseResetToCommit | ResponseRevertCommit | ResponseSetGlobalViewState | ResponseSetWorkspaceViewState | ResponseStartCodeReview | ResponseTagDetails | ResponseUpdateCodeReview | ResponseViewDiff | ResponseViewDiffWithWorkingFile | ResponseViewFileAtRevision | ResponseViewScm;
declare type PrimitiveTypes = string | number | boolean | symbol | bigint | undefined | null;
export declare type Writeable<T> = {
    -readonly [K in keyof T]: T[K];
};
export declare type DeepReadonly<T> = T extends PrimitiveTypes ? T : T extends (Array<infer U> | ReadonlyArray<infer U>) ? ReadonlyArray<DeepReadonly<U>> : {
